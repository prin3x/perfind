    ...
    return (
        ...
        <Fragment>
            ...
            <Tabs defaultActiveKey="1" centered style={{ borderRadius: "1rem" }}>
                <TabPane tab={
                    <span style={{ background: "linear-gradient(to right, #b8956c, #e3d5b0)", padding: "5rem" }}>ALL PRODUCT</span>} key="1">
                ...
                <TabPane tab={
                    <span style={{ background: "linear-gradient(to right, #b8956c, #e3d5b0)", padding: "5rem" }}>ADD PRODUCT</span>} key="2" style={{ background: "white" }}>
